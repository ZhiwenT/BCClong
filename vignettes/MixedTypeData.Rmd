...
We ran the model with 12,000 iterations, discard the first 2,000 sample, and kept every 10th sample. This resulted in 1,000 samples for each model parameter. The MCMC sampling process tooks about 30 minutes on an AMD Ryzen$^{TM}$ 5 5600X desktop computer.
